...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    ...
    {
      ref: "popupRef",
      class: _normalizeClass($setup.popupClassName()),
      "data-annotation-popup": "",
      style: _normalizeStyle($props.popupStyle),
    ...
    [
      _createElementVNode(
        "div",
        {
          class: _normalizeClass($setup.styles.header)
        },
        [
          $props.computedStyles && Object.keys($props.computedStyles).length > 0 ? (_openBlock(), _createElementBlock(
            "button",
            {
              key: 0,
              class: _normalizeClass($setup.styles.headerToggle),
              type: "button",
            ...
            [
              (_openBlock(), _createElementBlock(
                "svg",
                {
                  class: _normalizeClass([$setup.styles.chevron, $setup.isStylesExpanded ? $setup.styles.expanded : ""]),
                  width: "14",
                  height: "14",
                  viewBox: "0 0 14 14",
                  fill: "none",
              ...
              _createElementVNode(
                "span",
                {
                  class: _normalizeClass($setup.styles.element)
                },
                _toDisplayString($props.element),
                3
                /* TEXT, CLASS */
              )
            ],
          ...
          $props.timestamp ? (_openBlock(), _createElementBlock(
            "span",
            {
              key: 2,
              class: _normalizeClass($setup.styles.timestamp)
            },
            _toDisplayString($props.timestamp),
            3
            /* TEXT, CLASS */
      ...
      _createCommentVNode(" Collapsible computed styles section "),
      $props.computedStyles && Object.keys($props.computedStyles).length > 0 ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 0,
          class: _normalizeClass([$setup.styles.stylesWrapper, $setup.isStylesExpanded ? $setup.styles.expanded : ""])
        },
        [
          _createElementVNode(
            "div",
            {
              class: _normalizeClass($setup.styles.stylesInner)
            },
            [
              _createElementVNode(
                "div",
                {
                  class: _normalizeClass($setup.styles.stylesBlock)
                },
                [
                  (_openBlock(true), _createElementBlock(
                    _Fragment,
                    null,
                    _renderList($props.computedStyles, (value, key) => {
                      return _openBlock(), _createElementBlock(
                        "div",
                        {
                          key,
                          class: _normalizeClass($setup.styles.styleLine)
                        },
                        [
                          _createElementVNode(
                            "span",
                            {
                              class: _normalizeClass($setup.styles.styleProperty)
                            },
                            _toDisplayString($setup.kebab(String(key))),
                            3
                            /* TEXT, CLASS */
                          ),
                          ...
                          _createElementVNode(
                            "span",
                            {
                              class: _normalizeClass($setup.styles.styleValue)
                            },
      ...
      $props.selectedText ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 1,
          class: _normalizeClass($setup.styles.quote)
        },
        " \u201C" + _toDisplayString($props.selectedText.slice(0, 80)) + _toDisplayString($props.selectedText.length > 80 ? "..." : "") + "\u201D ",
        3
        /* TEXT, CLASS */
      )) : _createCommentVNode("v-if", true),
      _createElementVNode("textarea", {
        ref: "textareaRef",
        class: _normalizeClass($setup.styles.textarea),
        style: _normalizeStyle({ borderColor: $setup.isFocused ? $props.accentColor : void 0 }),
      ...
      _createElementVNode(
        "div",
        {
          class: _normalizeClass($setup.styles.actions)
        },
        [
          $props.onDelete ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 0,
              class: _normalizeClass($setup.styles.deleteWrapper)
            },
            [
              _createElementVNode(
                "button",
                {
                  class: _normalizeClass($setup.styles.deleteButton),
                  type: "button",
          ...
          _createElementVNode(
            "button",
            {
              class: _normalizeClass($setup.styles.cancel),
          ...
          _createElementVNode("button", {
            class: _normalizeClass($setup.styles.submit),
          ...
          }, _toDisplayString($props.submitLabel), 15, _hoisted_2)
        ],
        2
        /* CLASS */
      )
...
function render10(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock10(), _createElementBlock10("svg", {
    ...
    _createCommentVNode2(" Copy icon "),
    ...
    _createCommentVNode2(" Checkmark circle "),
    _createElementVNode10(
      "g",
      {
        class: "check-icon",
...
function render11(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock11(), _createElementBlock11("svg", {
    ...
    _createCommentVNode3(" Send arrow "),
    ...
    _createCommentVNode3(" Green checkmark circle "),
    _createElementVNode11(
      "g",
      {
        class: "send-check-icon",
        style: _normalizeStyle4($setup.checkStyle)
      },
      [..._cache[1] || (_cache[1] = [
        _createElementVNode11(
          "path",
    ...
    _createCommentVNode3(" Red error circle with exclamation "),
    _createElementVNode11(
      "g",
      {
        class: "send-error-icon",
        style: _normalizeStyle4($setup.errorStyle)
      },
      [..._cache[2] || (_cache[2] = [
        _createElementVNode11(
          "path",
...
function render12(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock12(), _createElementBlock12("svg", {
    ...
    _createCommentVNode4(" Send icon (document with arrow) "),
    ...
    _createCommentVNode4(" Checkmark circle (success state) "),
    _createElementVNode12(
      "g",
      {
        class: "sent-icon",
...
function render16(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock16(), _createElementBlock16("svg", {
    ...
    _createCommentVNode5(" Open state - full outline + pupil "),
    _createElementVNode16(
      "g",
      {
        class: "eye-open",
        style: _normalizeStyle6({ opacity: $props.isOpen ? 1 : 0 })
      },
      [..._cache[0] || (_cache[0] = [
        _createElementVNode16(
          "path",
    ...
    _createCommentVNode5(" Closed state - split outline + slash "),
    _createElementVNode16(
      "g",
      {
        class: "eye-closed",
        style: _normalizeStyle6({ opacity: $props.isOpen ? 0 : 1 })
      },
      [..._cache[1] || (_cache[1] = [
        _createElementVNode16(
          "path",
...
function render17(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock17(), _createElementBlock17("svg", {
    ...
    _createCommentVNode6(" Pause bars - visible when not paused "),
    _createElementVNode17(
      "path",
      {
        ...
        "stroke-width": "1.5",
        "stroke-linecap": "round",
        style: _normalizeStyle7({ opacity: $props.isPaused ? 0 : 1 })
      },
      null,
      4
      /* STYLE */
    ...
    _createCommentVNode6(" Play triangle - visible when paused "),
    _createElementVNode17(
      "path",
      {
        class: "play-triangle",
        ...
        stroke: "currentColor",
        "stroke-width": "1.5",
        style: _normalizeStyle7({ opacity: $props.isPaused ? 1 : 0 })
      },
      null,
      4
      /* STYLE */
...
function render24(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock24(), _createElementBlock24("svg", {
    ...
    viewBox: "0 0 24 24",
    fill: "none",
    style: _normalizeStyle8($props.style)
  }, [..._cache[0] || (_cache[0] = [
...
function render25(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock25(), _createElementBlock25("svg", {
    ...
    _createElementVNode25(
      ...
      null,
      [
        _createElementVNode25("clipPath", { id: "clip0_2_45" }, [
          _createElementVNode25("rect", {
            width: "24",
            height: "24",
            fill: "white"
          })
...
function render26(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock26(), _createElementBlock26("svg", {
    ...
    _createElementVNode26(
      ...
      null,
      [
        _createElementVNode26("clipPath", { id: "clip0_2_37" }, [
          _createElementVNode26("rect", {
            width: "24",
            height: "24",
            fill: "white"
          })
...
function render37(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock37(), _createElementBlock37("svg", {
    ...
    _createCommentVNode7(" Invisible hover area to catch all hover events "),
    _cache[0] || (_cache[0] = _createElementVNode37(
      "rect",
      {
        width: "28",
        height: "28",
    ...
    _createCommentVNode7(" Right ear "),
    _createElementVNode37("path", {
    ...
    _createCommentVNode7(" Face outline "),
    _createElementVNode37("path", {
      class: "bunny-face",
    ...
    _createCommentVNode7(" Animated bunny eyes "),
    _createElementVNode37("circle", {
    ...
    _createCommentVNode7(" Happy face on hover "),
    _createElementVNode37("text", {
...
var _sfc_main38 = /* @__PURE__ */ _defineComponent38({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const props = __props;
    const emit = __emit;
    const showDeleteState = computed2(() => (props.isHovered || props.isDeleting) && !props.isEditing);
    const showDeleteHover = computed2(() => showDeleteState.value && props.markerClickBehavior === "delete");
...
function render38(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock38(), _createElementBlock38(
    "div",
    {
      class: _normalizeClass2($setup.markerClass),
      "data-annotation-marker": "",
      ...
      onClick: _cache[2] || (_cache[2] = _withModifiers2(($event) => $setup.emit("click"), ["stop"])),
      onContextmenu: _cache[3] || (_cache[3] = ($event) => $setup.emit("contextmenu", $event))
    },
    [
      $setup.showDeleteState ? (_openBlock38(), _createElementBlock38(
        _Fragment2,
        { key: 0 },
        [
          $setup.showDeleteHover ? (_openBlock38(), _createBlock($setup["IconXmark"], {
            key: 0,
            size: $props.annotation.isMultiSelect ? 18 : 16
          }, null, 8, ["size"])) : (_openBlock38(), _createBlock($setup["IconEdit"], {
            key: 1,
            size: 16
          }))
        ],
        64
        /* STABLE_FRAGMENT */
      )) : (_openBlock38(), _createElementBlock38(
        "span",
        {
          key: 1,
          class: _normalizeClass2($props.renumberFrom !== null && $props.globalIndex >= $props.renumberFrom ? $setup.styles.renumber : void 0)
        },
        _toDisplayString2($props.globalIndex + 1),
        3
        /* TEXT, CLASS */
      )),
      _createCommentVNode8(" Tooltip "),
      $setup.showTooltip ? (_openBlock38(), _createElementBlock38(
        "div",
        {
          key: 2,
        ...
        [
          _createElementVNode38(
            "span",
            {
              class: _normalizeClass2($setup.styles.markerQuote)
            },
            [
              _createTextVNode2(
                _toDisplayString2($props.annotation.element) + " ",
                1
                /* TEXT */
              ),
              $props.annotation.selectedText ? (_openBlock38(), _createElementBlock38(
                _Fragment2,
                { key: 0 },
                [
                  _createTextVNode2(
                    ' \xA0"' + _toDisplayString2($props.annotation.selectedText.slice(0, 30)) + _toDisplayString2($props.annotation.selectedText.length > 30 ? "..." : "") + '" ',
                    1
                    /* TEXT */
                  )
                ],
          ...
          _createElementVNode38(
            "span",
            {
              class: _normalizeClass2($setup.styles.markerNote)
            },
            _toDisplayString2($props.annotation.comment),
            3
            /* TEXT, CLASS */
          )
        ],
...
var _sfc_main39 = /* @__PURE__ */ _defineComponent39({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const shouldRender = ref2(false);
    const position = ref2({ top: 0, right: 0 });
    const triggerRef = ref2(null);
    let timeoutId = null;
    ...
    const __returned__ = { props, isHovering, visible, shouldRender, position, triggerRef, get timeoutId() {
      ...
      exitTimeoutId = v;
    }, updatePosition, handleMouseEnter, handleMouseLeave, Teleport };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
function render39(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock39(), _createElementBlock39(
    _Fragment3,
    null,
    [
      ...
      (_openBlock39(), _createBlock2(_Teleport, { to: "body" }, [
        $setup.shouldRender ? (_openBlock39(), _createElementBlock39(
          "div",
          {
            key: 0,
            "data-feedback-toolbar": "",
          ...
          _toDisplayString3($props.content),
          5
          /* TEXT, STYLE */
...
import { ref as ref3, reactive } from "vue";
...
function useToolbarSettings() {
  ...
  const isDarkMode = ref3(true);
  const showEntranceAnimation = ref3(false);
  const mounted = ref3(false);
  const toolbarPosition = ref3(null);
  const isDraggingToolbar = ref3(false);
  const dragStartPos = ref3(null);
  const dragRotation = ref3(0);
...
function render40(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock40(), _createElementBlock40(
    "div",
    {
    ...
    [
      _createElementVNode40(
        ...
        [
          _createCommentVNode10(" Main settings page "),
          _createElementVNode40(
            "div",
            {
              class: _normalizeClass3([
            ...
            [
              _createElementVNode40(
                "div",
                {
                  class: _normalizeClass3($setup.styles.settingsHeader)
                },
                [
                  _createElementVNode40(
                    "span",
                    {
                      class: _normalizeClass3($setup.styles.settingsBrand)
                    },
                    [
                      _createElementVNode40(
                        "span",
                        {
                          class: _normalizeClass3($setup.styles.settingsBrandSlash),
                          style: _normalizeStyle11({ color: $props.settings.annotationColor, transition: "color 0.2s ease" })
                        },
                        "/",
                        6
                        /* CLASS, STYLE */
                  ...
                  _createElementVNode40(
                    "span",
                    {
                      class: _normalizeClass3($setup.styles.settingsVersion)
                    },
                    "v" + _toDisplayString4(_ctx.__VERSION__),
                    3
                    /* TEXT, CLASS */
                  ),
                  _createElementVNode40("button", {
                    class: _normalizeClass3($setup.styles.themeToggle),
                    ...
                    _createElementVNode40(
                      "span",
                      {
                        class: _normalizeClass3($setup.styles.themeIconWrapper)
                      },
                      [
                        _createElementVNode40(
                          "span",
                          {
                            class: _normalizeClass3($setup.styles.themeIcon)
                          },
                          [
                            $props.isDarkMode ? (_openBlock40(), _createBlock3($setup["IconSun"], {
                              key: 0,
                              size: 20
                            })) : (_openBlock40(), _createBlock3($setup["IconMoon"], {
                              key: 1,
                              size: 20
                            }))
                          ],
              ...
              _createElementVNode40(
                "div",
                {
                  class: _normalizeClass3($setup.styles.settingsSection)
                },
                [
                  _createElementVNode40(
                    "div",
                    {
                      class: _normalizeClass3($setup.styles.settingsRow)
                    },
                    [
                      _createElementVNode40(
                        "div",
                          ...
                          _createVNode($setup["ToolbarTooltip"], {
                            ...
                            default: _withCtx(() => [
                              _createElementVNode40(
                                "span",
                                {
                                  class: _normalizeClass3($setup.styles.helpIcon)
                                },
                                [
                      ...
                      _createElementVNode40(
                        "button",
                        {
                          class: _normalizeClass3([$setup.styles.cycleButton, !$props.isDarkMode ? $setup.styles.light : ""]),
                        ...
                        [
                          _createElementVNode40(
                            "span",
                            {
                              class: _normalizeClass3($setup.styles.cycleButtonText)
                            },
                            _toDisplayString4($setup.OUTPUT_DETAIL_OPTIONS.find((opt) => opt.value === $props.settings.outputDetail)?.label),
                            3
                            /* TEXT, CLASS */
                          ),
                          _createElementVNode40(
                            "span",
                            {
                              class: _normalizeClass3($setup.styles.cycleDots)
                            },
                            [
                              (_openBlock40(true), _createElementBlock40(
                                _Fragment4,
                                null,
                                _renderList2($setup.OUTPUT_DETAIL_OPTIONS, (option) => {
                                  return _openBlock40(), _createElementBlock40(
                                    "span",
                                    {
                                      key: option.value,
                  ...
                  _createElementVNode40(
                    ...
                    [
                      ...
                      _createElementVNode40(
                        "label",
                        {
                          class: _normalizeClass3([$setup.styles.toggleSwitch, !$props.isLocalhost ? $setup.styles.disabled : ""])
                        },
                        [
                          ...
                          _createElementVNode40(
                            "span",
                            {
                              class: _normalizeClass3($setup.styles.toggleSlider)
                            },
                            null,
                            2
                            /* CLASS */
              ...
              _createElementVNode40(
                ...
                [
                  _createElementVNode40(
                    "div",
                    {
                      class: _normalizeClass3([$setup.styles.settingsLabel, $setup.styles.settingsLabelMarker, !$props.isDarkMode ? $setup.styles.light : ""])
                    },
                    " Marker Colour ",
                    2
                    /* CLASS */
                  ...
                  _createElementVNode40(
                    "div",
                    {
                      class: _normalizeClass3($setup.styles.colorOptions)
                    },
                    [
                      (_openBlock40(true), _createElementBlock40(
                        _Fragment4,
                        null,
                        _renderList2($setup.COLOR_OPTIONS, (color) => {
                          return _openBlock40(), _createElementBlock40("div", {
                            key: color.value,
                            role: "button",
                            style: _normalizeStyle11({
                            ...
                            _createElementVNode40("div", {
                              ...
                              style: _normalizeStyle11({ backgroundColor: color.value }),
                              title: color.label
                            }, null, 14, _hoisted_42)
                          ], 14, _hoisted_32);
                        }),
                  ...
                  _createElementVNode40(
                    ...
                    [
                      ...
                      _createElementVNode40(
                        "label",
                        {
                          class: _normalizeClass3([$setup.styles.customCheckbox, $props.settings.autoClearAfterCopy ? $setup.styles.checked : ""]),
                          for: "autoClearAfterCopy"
                        },
                        [
                          $props.settings.autoClearAfterCopy ? (_openBlock40(), _createBlock3($setup["IconCheckSmallAnimated"], {
                            key: 0,
                            size: 14
                  ...
                  _createElementVNode40(
                    ...
                    [
                      ...
                      _createElementVNode40(
                        "label",
                        {
                          class: _normalizeClass3([$setup.styles.customCheckbox, $props.settings.blockInteractions ? $setup.styles.checked : ""]),
                          for: "blockInteractions"
                        },
                        [
                          $props.settings.blockInteractions ? (_openBlock40(), _createBlock3($setup["IconCheckSmallAnimated"], {
                            key: 0,
                            size: 14
                          })) : _createCommentVNode10("v-if", true)
                        ],
              ...
              _createElementVNode40(
                "div",
                {
                  class: _normalizeClass3([$setup.styles.settingsSection, $setup.styles.settingsSectionExtraPadding])
                },
                [
                  _createElementVNode40(
                    "button",
                    ...
                    [
                      ...
                      _createElementVNode40(
                        "span",
                        {
                          class: _normalizeClass3($setup.styles.settingsNavLinkRight)
                        },
                        [
                          $props.endpoint && $props.connectionStatus !== "disconnected" ? (_openBlock40(), _createElementBlock40(
                            "span",
                            {
                              key: 0,
                              class: _normalizeClass3([$setup.styles.mcpNavIndicator, $setup.styles[$props.connectionStatus]])
                            },
                            null,
                            2
                            /* CLASS */
          ...
          _createCommentVNode10(" Automations Page "),
          _createElementVNode40(
            "div",
            {
              class: _normalizeClass3([
            ...
            [
              ...
              _createCommentVNode10(" MCP Connection section "),
              _createElementVNode40(
                "div",
                {
                  class: _normalizeClass3($setup.styles.settingsSection)
                ...
                [
                  _createElementVNode40(
                    ...
                    [
                          ...
                          _createVNode($setup["ToolbarTooltip"], {
                            ...
                            default: _withCtx(() => [
                              _createElementVNode40(
                                "span",
                                {
                                  class: _normalizeClass3([$setup.styles.helpIcon, $setup.styles.helpIconNudgeDown])
                                },
                                [
                                  _createVNode($setup["IconHelp"], { size: 20 })
                                ],
                      ...
                      $props.endpoint ? (_openBlock40(), _createElementBlock40("div", {
                        key: 0,
                        class: _normalizeClass3([$setup.styles.mcpStatusDot, $setup.styles[$props.connectionStatus]]),
                        title: $props.connectionStatus === "connected" ? "Connected" : $props.connectionStatus === "connecting" ? "Connecting..." : "Disconnected"
                      }, null, 10, _hoisted_72)) : _createCommentVNode10("v-if", true)
                    ],
                    2
                    /* CLASS */
                  ),
                  _createElementVNode40(
                    "p",
                    {
                      class: _normalizeClass3([$setup.styles.automationDescription, !$props.isDarkMode ? $setup.styles.light : ""]),
                    ...
                    [
                      ...
                      _createElementVNode40(
                        "a",
                        {
                          ...
                          class: _normalizeClass3([$setup.styles.learnMoreLink, !$props.isDarkMode ? $setup.styles.light : ""])
                        },
                        "Learn more",
                        2
                        /* CLASS */
              ...
              _createCommentVNode10(" Webhooks section "),
              _createElementVNode40(
                "div",
                {
                  class: _normalizeClass3([$setup.styles.settingsSection, $setup.styles.settingsSectionGrow])
                },
                [
                  _createElementVNode40(
                    "div",
                    ...
                    [
                          ...
                          _createVNode($setup["ToolbarTooltip"], {
                            ...
                            default: _withCtx(() => [
                              _createElementVNode40(
                                "span",
                                {
                                  class: _normalizeClass3([$setup.styles.helpIcon, $setup.styles.helpIconNoNudge])
                                },
                                [
                                  _createVNode($setup["IconHelp"], { size: 20 })
                                ],
                      ...
                      _createElementVNode40(
                        "div",
                        {
                          class: _normalizeClass3($setup.styles.autoSendRow)
                        },
                        [
                          _createElementVNode40(
                            "span",
                          ...
                          _createElementVNode40(
                            "label",
                            {
                              class: _normalizeClass3([$setup.styles.toggleSwitch, !$props.settings.webhookUrl ? $setup.styles.disabled : ""])
                            },
                            [
                              _createElementVNode40("input", {
                                type: "checkbox",
                  ...
                  _createElementVNode40("textarea", {
                    class: _normalizeClass3([$setup.styles.webhookUrlInput, !$props.isDarkMode ? $setup.styles.light : ""]),
...
function useServerSync(options) {
  ...
  const currentSessionId = ref4(initialSessionId ?? null);
  const connectionStatus = ref4(
...
function useAnnotationState() {
  const pendingAnnotation = ref5(null);
  const pendingExiting = ref5(false);
  const editingAnnotation = ref5(null);
  const editExiting = ref5(false);
  const editingTargetElement = ref5(null);
  const editingTargetElements = ref5([]);
...
function useDrawing() {
  const isDrawMode = ref6(false);
  const drawStrokes = ref6([]);
  const hoveredDrawingIdx = ref6(null);
  const drawCanvasRef = ref6(null);
  let isDrawing = false;
  let currentStroke = [];
...
function useMultiSelect() {
  const pendingMultiSelectElements = ref8([]);
...
function useHover() {
  const hoverInfo = ref9(null);
  const hoverPosition = ref9({ x: 0, y: 0 });
...
function useMarkerVisibility(options) {
  ...
  const markersVisible = ref10(false);
  const markersExiting = ref10(false);
  const animatedMarkers = ref10(/* @__PURE__ */ new Set());
  const exitingMarkers = ref10(/* @__PURE__ */ new Set());
...
var _sfc_main41 = /* @__PURE__ */ _defineComponent41({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const isActive = ref11(false);
    const showMarkers = ref11(true);
    const scrollY = ref11(0);
    const isScrolling = ref11(false);
    const isFrozen = ref11(false);
    const showSettings = ref11(false);
    const showSettingsVisible = ref11(false);
    const settingsPage = ref11("main");
    const isTransitioning = ref11(false);
    const tooltipsHidden = ref11(false);
    const copied = ref11(false);
    const sendState = ref11("idle");
    ...
    const popupRef = ref11(null);
    const editPopupRef = ref11(null);
    let scrollTimeoutId = null;
    const dragRectRef = ref11(null);
    const highlightsContainerRef = ref11(null);
    const effectiveReactMode = computed3(() => getEffectiveReactMode());
...
`;
    ...
    watch5([shouldShowMarkers, annotations], () => {
    ...
    watch5(annotations, persistAnnotations, { deep: true });
    watch5(() => ({ ...settings }), saveSettings, { deep: true });
    watch5(isDarkMode, saveTheme);
    let prevDragging = false;
    watch5(isDraggingToolbar, (val) => {
    ...
    watch5([toolbarPosition, isActive, connectionStatus], constrainPosition);
    onMounted3(() => {
      loadFromStorage();
      scrollY.value = window.scrollY;
      ...
      watch5(connectionStatus, () => syncOnReconnect());
    ...
    }, constrainPosition, getPopupStyle, getActiveButtonStyle, Teleport: Teleport2, get parseComputedStylesString() {
...
export {
  AgentationToolbar_default as Agentation,
  AgentationToolbar_default as AgentationToolbar,
  AnimatedBunny_default as AnimatedBunny,
  AnnotationPopup_default as AnnotationPopup,
  IconChatEllipsis_default as IconChatEllipsis,
  IconCheck_default as IconCheck,
  IconCheckSmall_default as IconCheckSmall,
  IconCheckSmallAnimated_default as IconCheckSmallAnimated,
  IconCheckmark_default as IconCheckmark,
  IconCheckmarkCircle_default as IconCheckmarkCircle,
  IconCheckmarkLarge_default as IconCheckmarkLarge,
  IconChevronLeft_default as IconChevronLeft,
  IconChevronRight_default as IconChevronRight,
  IconClose_default as IconClose,
  IconCopyAlt_default as IconCopyAlt,
  IconCopyAnimated_default as IconCopyAnimated,
  IconEdit_default as IconEdit,
  IconEye_default as IconEye,
  IconEyeAlt_default as IconEyeAlt,
  IconEyeAnimated_default as IconEyeAnimated,
  IconEyeClosed_default as IconEyeClosed,
  IconEyeMinus_default as IconEyeMinus,
  IconGear_default as IconGear,
  IconHelp_default as IconHelp,
  IconListSparkle_default as IconListSparkle,
  IconMoon_default as IconMoon,
  IconPause_default as IconPause,
  IconPauseAlt_default as IconPauseAlt,
  IconPausePlayAnimated_default as IconPausePlayAnimated,
  IconPencil_default as IconPencil,
  IconPlayAlt_default as IconPlayAlt,
  IconPlus_default as IconPlus,
  IconSendAnimated_default as IconSendAnimated,
  IconSendArrow_default as IconSendArrow,
  IconSun_default as IconSun,
  IconTrash_default as IconTrash,
  IconTrashAlt_default as IconTrashAlt,
  IconXmark_default as IconXmark,
  IconXmarkLarge_default as IconXmarkLarge,
